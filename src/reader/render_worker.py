...
class PageRenderTask(QRunnable):
    ...
    def __init__(self, doc_reader: DocumentReader, page_num: int, zoom: float, theme: str = "day", skip_words: bool = False):
        super().__init__()
    ...
    def run(self):
        try:
            ...
            words = [] if self.skip_words else self.doc_reader.get_words(self.page_num)
